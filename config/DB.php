...
class DB{
    ...
    {
        $settings['dbname'] = 'radnici';
        $settings['dbhost'] = '127.0.0.1';
        $settings['dbuser'] = 'root';
        $settings['dbpass'] = '';
        $settings['dbport']='4307'; // vrv treba se obrise

        try{
            $dsn = 'mysql:dbname=' . $settings['dbname'] . ';host=' . $settings['dbhost'] . ';port=' . $settings['dbport']; // Dodajemo port u DSN, obrises port i odavde
